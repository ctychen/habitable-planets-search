...
# hsps = pd.read_excel("/media/rd3/cchen/cchen/gpu_codes_new/hsp_60_400_days_v2.xlsx")
...
dir_list1 = os.listdir('/media/rd3/cchen/cchen/hsp_gpu_fold/all_kepler_folded/')
print(len(dir_list1))
# print(dir_list1[0])
...
#     id = 3
    ...
    kic = int(get_numbers_from_filename(dir_list1[id]))
    kic_index = find_first(int(get_numbers_from_filename(dir_list1[id])), kepler_id)
    print(kid)
...
#9002278_1_filt.npz
    ...
    if (all_status[kic_index] == 'CONFIRMED'):
        
#     file_name = '/media/rd3/cchen/cchen/kepler_ml_v3/norm_lcs/v2/hsps_v2/' + str(kepler_id[id]) + '_filt.npz'

        file_name = '/media/rd3/cchen/cchen/kepler_ml_v3/norm_lcs/v2/all_kepler/' + str(kepler_id[id]) + '_filt.npz'
    ...
    #     index_min = np.argmin(np.abs(period_search_array-period))
        ...
        print(gpu_cmd)
        os.system(gpu_cmd)
    #     saved_file = '/media/rd3/cchen/cchen/hsp_gpu_fold/all_kepler_folded/data_'+str(kepler_id[id])+'_hps.bin'
    #     p_num = 44000 #38400
    #     p_num = 32640
    ...
    #     plt.savefig('/media/rd3/cchen/cchen/hsp_gpu_fold/figures/v3/' + str(kid)+'.png')
    #     plt.show()
    #     plt.close()
